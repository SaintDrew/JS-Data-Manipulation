...
// add to the front of an array, returns the new length of the array
movies.unshift("Stars Wars")
...
console.log("movie removed: ", startMovie, "array after shift: ", movies)
/**
...
// order or arguments - array.splice(start, deleteCount, newItem1, newItem2...)

let coolMovies = ["Mean Girls", "Wonka", "Harlem", "My Cousin Vinny"]

let removedMovies = coolMovies.splice(3, 1, 'Spaceballs', 'Alien');
// This starts at element 3 (My Cousin Vinny), removes 1 element, and adds Spaceballs and Alien.
// removedMovies => ['My Cousin Vinny']
// movies => ['Mean Girls', 'Wonka', 'Harlem', 'Spaceballs', 'Alien']
...
// sort()
let numArray3 = [4, 8, 1, 0, -14, 22, 77, 1388, 20];
let movies3 = ['Shrek', 'Caddyshack', 'Batman', 'Interstellar', 'Scarface', 'Spaceballs', 'Alien', 'The Count of Monte Cristo'];

numArray3.sort(); // [-14, 0, 1, 1388, 20, 22, 4, 77, 8]
movies3.sort(); // ['Alien', 'Batman', 'Caddyshack', 'Interstellar', 'Scarface', 'Shrek', 'Spaceballs', 'The Count of Monte Cristo']
...
// it will return -1 if your search value doesn't exist in the array

let batmanIndex = movies4.indexOf("Batman") // 2
